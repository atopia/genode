...
void Vmx_vm_session_component::_attach(addr_t phys_addr, addr_t vm_addr, size_t size)
{
	using namespace Hw;
...
void Vmx_vm_session_component::_attach_vm_memory(Dataspace_component &dsc,
...
void Vmx_vm_session_component::_detach_vm_memory(addr_t vm_addr, size_t size)
{
	_table.remove_translation(vm_addr, size, _table_array.alloc());
}


void * Vmx_vm_session_component::_alloc_table()
{
...
Vmx_vm_session_component::Vmx_vm_session_component(Rpc_entrypoint &ds_ep,
                                                   Resources resources,
                                                   Label const &label,
                                                   Diag diag,
...
Vmx_vm_session_component::~Vmx_vm_session_component()
{
