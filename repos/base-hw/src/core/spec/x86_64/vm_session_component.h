	...
	public  Region_map_detach
{
	private:
		...
		virtual void *_alloc_table()
		{
			return nullptr;
		}

		virtual void  _attach(addr_t, addr_t, size_t)
		{ }

		/* helpers for vm_session_common.cc */
		virtual void _attach_vm_memory(Dataspace_component &, addr_t, Attach_attr) { };
		virtual void _detach_vm_memory(addr_t, size_t) { };
	...
	protected:
		...
		void set_page_table_addr(void *phys_addr) {
			_id.table = phys_addr;
		}
